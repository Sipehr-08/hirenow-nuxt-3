  ...
  <section class="services">
    <div class="services__wrap">
      <div class="services__title">
        <div class="services__head">More than 10000 service provider</div>
        <div class="services__subhead">With honest reviews in categories</div>
      </div>
      <div class="services__flex-box">
        <ul class="services__menu">
          <li class="services__item">
            <a class="services__link" href="#">
              <img
                class="service__img img-fluid"
                src="/images/services_icons/a.svg"
                alt=""
              />
          ...
          <li class="services__item">
            <a class="services__link" href="#"
              ><img
                class="service__img img-fluid"
                src="/images/services_icons/a1.svg"
                alt=""
              /><span>Beaty &amp; Health</span></a
            >
          </li>
          <li class="services__item">
            <a class="services__link" href="#"
          ...
          <li class="services__item">
            <a class="services__link" href="#"
              ><img
                class="service__img img-fluid"
                src="/images/services_icons/a16.svg"
                alt=""
              /><span>Constuction &amp; Repair</span></a
            >
          </li>
          <li class="services__item">
            <a class="services__link" href="#"
      ...
      <div class="service__btn">
        <a class="show-services hover:bg-primary hover:text-white" href="#"
          >View all services</a
        >
      </div>
    </div>
